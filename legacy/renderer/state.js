// global renderer state, accessed as state.<name> (getters/setters below)
...
let savedTagSelections = new Set();
let temporaryTagSelections = new Set(); // ctrl+click selections
...
// auto-seek
let isAutoResetDisabled = false; // true after a manual seek outside the trim bounds
