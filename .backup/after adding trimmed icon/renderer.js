  ...
  try {
    ...
    for (const clip of clips) {
      ...
      try {
        ...
        // Check if the clip has been trimmed
        ...
        clipElement.innerHTML = `
          ...
          ${isTrimmed ? `<div class="trimmed-indicator" title="This video has been trimmed">${scissorsIcon}</div>` : ''}
          <div class="clip-info">
...
function removeClipFromGrid(originalName) {
...
async function confirmAndDeleteClip() {
  ...
  const isConfirmed = confirm(`Are you sure you want to delete "${clipToDelete.customName}"? This action cannot be undone.`);
